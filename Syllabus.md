...
<ul style="list-style:none">
    <li>
        1. <a href="">Acerca del curso</a>
        <ul style="list-style:none">
            <li>
                1.1. <a>Sobre programación y programación orientada a objetos</a>                
            </li>
            <li>
                1.2. <a>Intenciones del curso</a>                
            </li>
            <li>
                1.3. <a>Competencias</a>                
            </li>
            <li>
                1.4. <a>Unidades temáticas</a>   
                <ul style="list-style:none">
                    <li>
                        1.4.1. <a>Objetos, clases y mensajes</a>                
                    </li>
                    <li>
                        1.4.2. <a>Tipos y tipos genéricos</a>                
                    </li>
                    <li>
                        1.4.3. <a>Herencia</a>                
                    </li>
                    <li>
                        1.4.4. <a>Composición y delegación</a>                
                    </li>
                    <li>
                        1.4.5. <a>Excepciones</a>                
                    </li>
                </ul>             
            </li>
             <li>
    ...
    <li>
        2. <a>Enseñanza y aprendizaje</a>
        <ul style="list-style:none">
            <li>
                2.1. <a>Cómo enseñamos</a>                
            </li>
            <li>
                2.2. <a>Eres dueño de tu aprendizaje</a>                
            </li>
            <li>
                2.3. <a>Aplicación al proyecto</a>                
            </li>
            <li>
                2.4. <a>Webasignatura</a>               
            </li>
        </ul>
    </li>
     <li>
        3. <a>Aprobación del curso</a>
        <ul style="list-style:none">
            <li>
                3.1. <a>Asistencia</a>                
            </li>
            <li>
                3.2. <a>Evaluaciónes</a>                
            </li>
            <li>
                3.3. <a>Calificaciones</a>                
                <ul style="list-style:none">
                    <li>
                        3.3.1. <a>Escala de calificaciones</a>                
                    </li>
                    <li>
                        3.3.2. <a>Calificaciones del curso</a>                
                    </li>
                    <li>
                        3.3.3. <a>Aprobación final</a>                
                    </li>
                </ul>
            </li>
        </ul>
    ...
    <li>
        4. <a>Honestidad Academémica</a>
    </li>
    <li>
        5. <a>Detalles de las competencias</a>
    </li>
    <li>
        6. <a>Indicadores de logro</a>
    </li>
</ul>
...
- Gonzalo Pennino
- Bernardo Rythchemberg

### 1.1 Sobre programación y programación orientada a objetos
...
#### 1.4.1 Objetos, clases y mensajes
...
#### 1.4.4 Composición y delegación
...
#### 1.4.5 Programar contra especificaciones
...
> ⚐ Importante
> 
> Cuidar tu ambiente de desarrollo es una cuestión de actitud. Una herramienta mal instalada o mal configurada, algo que no funciona como debe, les puede traer problemas y les va a hacer perder tiempo; para evitar perder tiempo, es necesario invertir tiempo en mantener el ambiente de desarrollo funcionando correctamente<sup>1</sup>.

Al comienzo de cada unidad temática vamos a pedirte que realices antes de venir a clase algunas actividades preliminares de preparación para el aprendizaje en clase. Las actividades preliminares incluyen lectura de material creado por los profesores, capítulos de libros, artículos de revistas, videos disponibles en línea, etc. en webasignatura <sup>2</sup>. Vamos a evaluar que hayas realizado las actividades preliminares, pues son parte del proceso de aprendizaje. El detalle de esta evaluación está más adelante en la sección Evaluaciones, en la página 9 de este documento.
...
Las definiciones de términos necesarios para entender los conceptos están disponibles en "tarjetas" en webasignatura <sup>3</sup>.
...
<table id="card">
    ...
    <tr style="vertical-align: top;text-align: justify;">
        <td style="vertical-align: middle">
            <img src="./Assets/role.png" style="width:100px">     
        <td>
            <p>
                Juego de roles
            </p>
    ...
    <tr style="vertical-align: top;text-align: justify;">
        <td style="vertical-align: middle">
            <img src="./Assets/pencil.png" style="width:100px">     
        </td>
        <td>
            <p>
                Dibujos y poster
    ...
    <tr style="vertical-align: top;text-align: justify;">
        <td style="vertical-align: middle">
            <img src="./Assets/programacion.png" style="width:100px">     
        </td>
        <td>
            <p>
                Programación
    ...
    <tr style="vertical-align: top;text-align: justify;">
        <td style="vertical-align: middle">
            <img src="./Assets/evaluation.png" style="width:100px">     
        </td>
        <td>
            <p>
...
![Secuencia](./Assets/sequencia.png)
...
### 2.2 Eres dueño de tu aprendizaje
...
### 2.3 Aprendizaje basado en proyectos y en equipos
...
### 3.3 Calificaciones
#### 3.3.1 Escala de calificaciones
...
#### 3.3.2 Calificaciones del curso
